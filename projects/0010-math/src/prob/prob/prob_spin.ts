...
import { eForceType, EWinType } from "./probLocalData";
...
function stateNG(
  ...
  // 初始化
  gameState.forceBingoType = eForceType.None;
  ...
  gameState.forceBingoType = result.Out.forceBingoType;
...
function stateFG(
  ...
  // [BuyFeatureMode]
  fgInput.forceBingoType = gameState.forceBingoType;
